...
iamctl controls the iam platform, is the client side tool for iam platform.
 ...
 Find more information at: https://github.com/marmotedu/iam/blob/master/docs/user-guide/iamctl/iamctl.md
...
* [iamctl sign](iamctl_sign.md)	 - Sign a jwt token with given secretId and secretKey
